#= Script to generate the in-silico training set for the test-case, doubling the sampling time.
...
for noise_magnitude in noise_magnitudes
  ...
  for problem in problems
    ...
    ode_data_std = reshape(repeat(noise_magnitude * max_variation, outer=42), size(ode_data)) 
    ...
    folder_name = "e"*string(noise_magnitude)*"_doubled/"
