...
par_opt = deserialize("local_optima_found/cell_ap_opt_05_fixed_p2p4.jld")
...
#set the sliding window from command line arguments if present
iterative_growing_window_steps = 3
