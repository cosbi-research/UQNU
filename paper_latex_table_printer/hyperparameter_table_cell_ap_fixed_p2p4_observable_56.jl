#= 
Script to print the table of tuned hyperparameters for the cell apoptosis UDE model trained on DS_00 and DS_05,
fixing the values of the mechanistic parameters p2 and p4 to their relative values, assuming that only y5 and y6 are observable.
=#
...
########## error 0.0 ################
hyperparameters_00 = deserialize("results_hyperparameter_tuned/cell_ap_c_00_best_params.jld")
hyperparameters_00_best_trial = deserialize("results_hyperparameter_tuned/cell_ap_c_00_best_trial.jld")

########## error 0.05 ###############
hyperparameters_05 = deserialize("results_hyperparameter_tuned/cell_ap_c_05_best_params.jld")
hyperparameters_05_best_trial = deserialize("results_hyperparameter_tuned/cell_ap_c_05_best_trial.jld")
