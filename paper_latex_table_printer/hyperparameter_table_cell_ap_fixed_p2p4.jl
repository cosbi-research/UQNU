...
fixing the values of the mechanistic parameters p2 and p4 to their relative values.
=#
...
########## error 0.0 ################
hyperparameters_00 = deserialize("results_hyperparameter_tuned/cell_ap_b_00_best_params.jld")
hyperparameters_00_best_trial = deserialize("results_hyperparameter_tuned/cell_ap_b_00_best_trial.jld")

########## error 0.05 ###############
hyperparameters_05 = deserialize("results_hyperparameter_tuned/cell_ap_b_05_best_params.jld")
hyperparameters_05_best_trial = deserialize("results_hyperparameter_tuned/cell_ap_b_05_best_trial.jld")
