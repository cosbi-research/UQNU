#= 
Script to print the table of estimated mechanistic parameters for the cell apoptosis UDE model trained on DS_00 and DS_05.
=#
...
par_opt_00 = deserialize("results_local_optima_found/ca_opt_00.jld")
par_opt_05 = deserialize("results_local_optima_found/ca_opt_05.jld")

ci_00 = deserialize("results_Fisher_confidence_intervals/cell_ap_opt_00_fisher_CI.jld")
ci_05 = deserialize("results_Fisher_confidence_intervals/cell_ap_opt_05_fisher_CI.jld")
