...
original_ode_par = [p1, p2, p3, p4, p5, p6, p7, p8, p9]
...
original_learning_rate_adam = 0.0201441
ms_group_size = 8
ms_continuity_term = 11.1217
...
function internal_objective(trial, seed)
  ...
  uode_derivative_function = get_uode_model_function(approximating_neural_network, st, original_ode_par)
