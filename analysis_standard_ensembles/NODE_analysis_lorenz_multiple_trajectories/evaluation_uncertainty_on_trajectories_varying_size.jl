...
experimental_data = deserialize("../data_generator_traj_1/lorenz_in_silico_data_no_noise.jld")
...
for ensemble_dimension in ensemble_dimensions
    ...
    ensembles = [tmp_ensemble[(k*ensemble_dimension+1):(k*ensemble_dimension+ensemble_dimension)] for k in 0:min(14, Int(floor(length(tmp_ensemble)/ensemble_dimension)) - 1)]
