...
serialize("bounding_box_trajectory_damped_1.jld", [min_y1_new, max_y1_new, min_y2_new, max_y2_new])
...
#save the data
serialize("damped_oscillator_in_silico_data_no_noise_pure_traj.jld", df_pure)
