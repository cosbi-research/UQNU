#!/bin/sh
#SBATCH --job-name=##MODEL##_##JOB_NAME##       
...
/cosbi/home/giampiccolo/.juliaup/bin/julia --threads 20 --project=../. ensemble_generator_depth_training_methods.jl ##SCRIPT_ARGUMENTS##