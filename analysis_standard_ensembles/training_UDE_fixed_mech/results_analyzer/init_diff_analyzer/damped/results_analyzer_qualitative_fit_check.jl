...
training_data_structure = deserialize("../../../data_generator/do_training_data_structure_err_1.jld")
trajectories = [1, 2, 3]
...
results_1 = deserialize("ensemble_results_model_3_gain_1.0_reg_0_0.0.jld")
...
function compute_likelihood_on_trajectory(experimental_data_tmp, model_simulation, max_oscillations_tmp)
    ...
    return 1/n * (sum(residuals_first.^2) + sum(residuals_second.^2))
end
...
#save the results 
serialize("ensemble_results_model_3_gain_1.0_reg_0_0.0_to_keep.jld", results_1_to_keep)
