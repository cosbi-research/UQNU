...
plt = Plots.scatter(sol_as_array_1[1,:], sol_as_array_1[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "blue")
Plots.scatter!(plt, sol_as_array_2[1,:], sol_as_array_2[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "blue")
Plots.scatter!(plt, sol_as_array_3[1,:], sol_as_array_3[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "blue")
Plots.plot!(plt, sol_as_array_1[1,:], sol_as_array_1[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "blue")
Plots.plot!(plt, sol_as_array_2[1,:], sol_as_array_2[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "blue")
Plots.plot!(plt, sol_as_array_3[1,:], sol_as_array_3[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "blue")
...
Plots.scatter!(plt, sol_as_array_1[1,:], sol_as_array_1[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "red")
Plots.scatter!(plt, sol_as_array_2[1,:], sol_as_array_2[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "red")
Plots.scatter!(plt, sol_as_array_3[1,:], sol_as_array_3[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "red")
Plots.plot!(plt, sol_as_array_1[1,:], sol_as_array_1[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "red")
Plots.plot!(plt, sol_as_array_2[1,:], sol_as_array_2[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "red")
Plots.plot!(plt, sol_as_array_3[1,:], sol_as_array_3[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "red")
Plots.plot!(plt, legend=false)
...
serialize("bounding_box_trajectory_lv_2.jld", [min_y1_new, max_y1_new, min_y2_new, max_y2_new])
...
#save in a dataframe the noisy simulation
df_pure = DataFrame(t = times, x1 = sol_as_array_1[1,:], x2 = sol_as_array_1[2,:], traj = repeat([1], length(times)))
df_pure = vcat(df_pure, DataFrame(t = times, x1 = sol_as_array_2[1,:], x2 = sol_as_array_2[2,:], traj = repeat([2], length(times))))
df_pure = vcat(df_pure, DataFrame(t = times, x1 = sol_as_array_3[1,:], x2 = sol_as_array_3[2,:], traj = repeat([3], length(times))))

#save the data
serialize("lotka_volterra_in_silico_data_no_noise_pure_trajectory.jld", df_pure)
...
Plots.scatter!(plt, sol_as_array_1[1,:], sol_as_array_1[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "green")
Plots.scatter!(plt, sol_as_array_2[1,:], sol_as_array_2[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "green")
Plots.scatter!(plt, sol_as_array_3[1,:], sol_as_array_3[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "green")
Plots.plot!(plt, sol_as_array_1[1,:], sol_as_array_1[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "green")
Plots.plot!(plt, sol_as_array_2[1,:], sol_as_array_2[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "green")
Plots.plot!(plt, sol_as_array_3[1,:], sol_as_array_3[2, :], label="Lotka-Volterra dynamics", xlabel="Prey", ylabel="Predator", color = "green")
Plots.plot!(plt, legend=false)
