...
results_1 = deserialize("ensemble_results_model_1_gain_1.0_reg_0.jld")
results_01 = deserialize("ensemble_results_model_1_gain_0.1_reg_0.jld")
results_001 = deserialize("ensemble_results_model_1_gain_0.01_reg_0.jld")
...
seed = 0
rng = StableRNG(seed)
sampled_seeds = [sample(seeds, 20) for i in 1:10]
...
Plots.histogram!([r.cicp for r in results_001_analyzed], bins=bins, label="cicp 0.01", alpha=0.5)
...
plt = Plots.histogram([r.mean_area for r in results_1_analyzed], bins=bins, label="gain 1.0", xlabel="Mean area", ylabel="Frequency", title="Mean area distribution", alpha=0.5)
Plots.histogram!([r.mean_area for r in results_01_analyzed], bins=bins, label="gain 0.1", alpha=0.5)
Plots.histogram!([r.mean_area for r in results_001_analyzed], bins=bins, label="gain 0.001", alpha=0.5)
