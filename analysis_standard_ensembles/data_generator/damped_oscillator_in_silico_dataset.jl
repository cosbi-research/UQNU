...
times = range(initial_time_training, end_time_training, step=0.0025)
...
plt = Plots.scatter(sol_as_array_1[1,:], sol_as_array_1[2, :], label="Damped oscillator dynamics", xlabel="y1", ylabel="y2", legend=false)
Plots.scatter!(plt, sol_as_array_2[1,:], sol_as_array_2[2, :], label="Damped oscillator dynamics", xlabel="y1", ylabel="y2")
Plots.scatter!(plt, sol_as_array_3[1,:], sol_as_array_3[2, :], label="Damped oscillator dynamics", xlabel="y1", ylabel="y2")
Plots.plot!(plt, sol_as_array_1[1,:], sol_as_array_1[2, :], label="Damped oscillator dynamics", xlabel="y1", ylabel="y2")
Plots.plot!(plt, sol_as_array_2[1,:], sol_as_array_2[2, :], label="Damped oscillator dynamics", xlabel="y1", ylabel="y2")
Plots.plot!(plt, sol_as_array_3[1,:], sol_as_array_3[2, :], label="Damped oscillator dynamics", xlabel="y1", ylabel="y2")

Plots.savefig(plt, "damped_oscillator_in_silico_data_extended.png")
...
#save the data
serialize("damped_oscillator_in_silico_data_no_noise_extended.jld", df)
...
Plots.savefig(plt, "damped_oscillator_in_silico_data_with_bounding_box.png")

#save the bounding bounding_box_epanded
serialize("damped_oscillator_in_silico_data_bounding_box.jld", bounding_box_epanded)
...
#pure trajectory dataframe 
prob = ODEProblem(ground_truth_function, original_u0_1, (initial_time_training, end_time_training), original_parameters)
sol_1 = solve(prob, Tsit5(), u0=original_u0_1, saveat=0.001, reltol=reltol, abstol=abstol)
sol_2 = solve(prob, Tsit5(), u0=original_u0_2, saveat=0.001, reltol=reltol, abstol=abstol)
sol_3 = solve(prob, Tsit5(), u0=original_u0_3, saveat=0.001, reltol=reltol, abstol=abstol)
...
#save the data
serialize("damped_oscillator_in_silico_data_no_noise_pure_traj.jld", df)
