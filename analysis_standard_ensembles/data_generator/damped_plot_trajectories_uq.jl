...
experimental_data = deserialize("damped_oscillator_in_silico_data_no_noise.jld")
...
for initial_point in initial_points[1:trajectory_number]
    ...
    tspan = (0.0, 10.0)
    #define the problem
    prob = ODEProblem(ground_truth_function!, [u0[1], u0[2]], tspan, original_parameters)
...
Plots.savefig(plt, "damped_oscillator_trajectories_test.svg")
