...
for error_level in error_levels
    ...
    pure_trajectory_file = "damped_oscillator_in_silico_data_no_noise_pure_traj.jld"
    ...
    #save as png
    Plots.savefig("damped_oscillator_training_data_structure_err_"*string(error_level)*".png")
    Plots.savefig(plt_extended_bounding_box, "damped_training_data_structure_err_"*string(error_level)*"_extended_bounding_box.png")
