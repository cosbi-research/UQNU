...
for model in models
    ...
    hyp_filename="hyper_parameter_manual_tuning/"
    if model == 1
      hyp_filename = hyp_filename*"/hyperparameters_LV.jld"
    elseif model == 2
      hyp_filename = hyp_filename*"/hyperparameters_LORENZ.jld"
    else
      hyp_filename = hyp_filename*"/hyperparameters_DAMPED.jld"
    end
