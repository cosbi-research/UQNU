...
max_oscillations_1 = [maximum(experimental_data_1.x1) - minimum(experimental_data_1.x1), maximum(experimental_data_1.x2) - minimum(experimental_data_1.x2), maximum(experimental_data_1.x3) - minimum(experimental_data_1.x3)]
max_oscillations_2 = [maximum(experimental_data_2.x1) - minimum(experimental_data_2.x1), maximum(experimental_data_2.x2) - minimum(experimental_data_2.x2), maximum(experimental_data_2.x3) - minimum(experimental_data_2.x3)]
max_oscillations_3 = [maximum(experimental_data_3.x1) - minimum(experimental_data_3.x1), maximum(experimental_data_3.x2) - minimum(experimental_data_3.x2), maximum(experimental_data_3.x3) - minimum(experimental_data_3.x3)]
...
function compute_likelihood_on_trajectory(experimental_data_tmp, model_simulation, max_oscillations_tmp)
    ...
    residuals_total = [residuals_first residuals_second residuals_third]
    ...
    sigma_3 = alpha_estimate * max_oscillations_tmp[3]
    ...
    #loglikelihood third variable
    loglikelihood_3 = -n / 2 * log(2 * pi) - n * log(sigma_3) - 1 / (2 * sigma_3^2) * sum((experimental_data_tmp.x3 .- model_simulation[3, :]) .^ 2)
