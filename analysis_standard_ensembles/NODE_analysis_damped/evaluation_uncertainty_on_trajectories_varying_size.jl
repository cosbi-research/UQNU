...
calibrations = deserialize("ensemble_results_model_3_with_seed.jld")
...
for ensemble_dimension in ensemble_dimensions
    ...
    ensembles = [calibrations[(k*ensemble_dimension+1):(k*ensemble_dimension+ensemble_dimension)] for k in 0:4]
