...
ensemble = deserialize("ensemble_results_model_3_gain_1.0_reg_0_0.0_to_keep.jld")
...
plt = Plots.scatter([p[1] for p in points_to_plot], [p[2] for p in points_to_plot], label="sampled points", xlabel="y1", ylabel="y2", zcolor=ground_truth_in_ensemble_to_plot, color=:viridis, markerstrokewidth = 0, markersize = 3)
