...
results_1 = deserialize("ensemble_results_model_1_gain_1.0_reg_0_0.0_to_keep.jld")

(:elapsed_time, :training_res, :net_status, :learning_rate_adam, :neural_network_dimension, :activation_function, :regularization, :regularization_coefficient_1, :regularization_coefficient_2, :gain, :error_level, :validation_likelihood, :status)
...
serialize("ensemble_results_model_1_with_seed.jld", results_1_with_seed)