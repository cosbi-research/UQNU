...
#plot the densities comparing the two
plt = Plots.boxplot(["Standard" for _ in single_cicps], single_cicps, label="MOD 800 epochs", xlabel="", ylabel="CP", alpha=0.5, color=:lightblue)
Plots.boxplot!(plt, ["Maximized OOD disagreement" for _ in single_cicps_maximized], single_cicps_maximized, label="MOD 1500 epochs", alpha=0.5, color=:lightblue)
