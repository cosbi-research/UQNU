...
trajectories = []
for i in 1:10
    maximized_ensemble_folder_results = "../results_maximized/lv/result_lv$i/results.jld"
    variance_ensembles = "../results_maximized/lv/result_lv$i/variances_lv.jld"
    cicp_ensembles = "../results_maximized/lv/result_lv$i/cicps_lv.jld"
    traj_ensemble = "../results_maximized/lv/result_lv$i/trajectories_lv.jld"
