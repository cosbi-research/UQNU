...
trajectories = []
for i in 1:10
    maximized_ensemble_folder_results = "../results_maximized/damped/result_damped$i/results.jld"
    variance_ensembles = "../results_maximized/damped/result_damped$i/variances_damped.jld"
    cicp_ensembles = "../results_maximized/damped/result_damped$i/cicps_damped.jld"
    traj_ensemble = "../results_maximized/damped/result_damped$i/trajectories_damped.jld"
...
for variance in variances
    ...
    for model_count in 1:length(variance)
        ...
        traj = trajectories[ensemble_index][model_count][1:(end-1)]
