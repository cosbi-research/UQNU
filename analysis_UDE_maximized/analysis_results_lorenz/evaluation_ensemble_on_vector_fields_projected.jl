...
serialize("results_analysis_projected.jld", results)

results_deserialized = deserialize("results_analysis_projected.jld")
...
Plots.savefig(plt, "ground_truth_in_ensemble_projected.svg")
Plots.savefig(plt, "ground_truth_in_ensemble_projected.png")
