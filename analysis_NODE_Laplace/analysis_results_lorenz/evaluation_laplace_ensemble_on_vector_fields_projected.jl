...
ensembles = []
for i in 1:10
    maximized_ensemble_folder = "../results_Laplace/lorenz/result_lorenz_laplace$i/ensemble_laplace_approximation$i.jld"
...
serialize("results_analysis_projected_naive.jld", results)

results_deserialized = deserialize("results_analysis_projected_naive.jld")
...
experimental_points_projected_to_plot = (
    alphas = alphas,
    experimental_points_centered_basis = experimental_points_centered_basis,
)
serialize("experimental_points_projected_to_plot.jld", experimental_points_projected_to_plot)
...
Plots.plot!(plt, title="Lorenz (Laplace)", legend=:topleft)
Plots.plot!(plt, 
...
Plots.savefig(plt, "ground_truth_in_ensemble_projected_standard.svg")
Plots.savefig(plt, "ground_truth_in_ensemble_projected_standard.png")
