...
mc_vector_field_standard = deserialize("cicps_distribution_laplcae.jld")
...
#serialize in a file
serialize("comparison_results_lv.jld", (results_vector_field=results_vector_field, results_trajectory=results_trajectory))