...
ensembles = []
for i in 1:10
    maximized_ensemble_folder = "../results_MOD/lv/result_lv$i/results.jld"
...
trained_naive_ensemble = deserialize("../training_NODE_results/lv/ensemble_results_model_1_with_seed.jld")
