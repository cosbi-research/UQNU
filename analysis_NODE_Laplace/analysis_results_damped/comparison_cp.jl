...
mc_vector_field_standard = deserialize("cicps_distribution_laplace.jld")
...
c_trajectory_standard = deserialize("trajectory_results_total_laplace.jld")
...
#serialize in a file
serialize("comparison_results_damped.jld", (results_vector_field=results_vector_field, results_trajectory=results_trajectory))