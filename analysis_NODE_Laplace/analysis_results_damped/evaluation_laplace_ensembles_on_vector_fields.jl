...
naive_ensembles = []
for i in 1:10
    maximized_ensemble_folder = "../results_Laplace/damped/result_damped_laplace$i/ensemble_laplace_approximation$i.jld"
...
Plots.plot!(plt, title="Damped Oscillator (Laplace)", legend=:topleft)
Plots.plot!(plt, 
...
serialize("cicps_distribution_laplace.jld", single_cicps)
