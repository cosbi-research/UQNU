...
ensembles = []
for i in 1:10
    maximized_ensemble_folder = "../results_MOD/damped/result_damped$i/results.jld"
...
trained_naive_ensemble = deserialize("../training_NODE_results/damped/ensemble_results_model_3_with_seed.jld")
single_parameter_training = trained_naive_ensemble[2]
...
Plots.histogram!(plt, log10.(costs_naive), label="Laplace", color="red", alpha=0.5, bins=bins)
#vline in 10^-3
