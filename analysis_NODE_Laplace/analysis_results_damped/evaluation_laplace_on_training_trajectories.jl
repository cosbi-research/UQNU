...
for i in trajectories
    ...
    for j in axes(ensembles, 1)
        ...
        for member in ensemble
            ...
            simulation = solve(prob, Vern7(), saveat=0.1, reltol=1e-5, abstol=1e-6)
    ...
    Plots.savefig(plt, joinpath(training_trajectories_folder, "ensemble_training_trajectories_laplace_$i.png"))
    Plots.savefig(plt, joinpath(training_trajectories_folder, "ensemble_training_trajectories_laplace_$i.svg"))
