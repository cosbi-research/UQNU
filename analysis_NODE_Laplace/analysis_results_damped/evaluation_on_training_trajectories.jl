...
for i in trajectories
    ...
    Plots.savefig(plt, joinpath(training_trajectories_folder, "ensemble_training_trajectories_maximized_$i.png"))
    Plots.savefig(plt, joinpath(training_trajectories_folder, "ensemble_training_trajectories_maximized_$i.svg"))
end