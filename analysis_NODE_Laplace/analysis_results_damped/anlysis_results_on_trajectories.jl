...
naive_trajectory_results = deserialize("trajectory_results_total_laplace.jld")
...
plt = Plots.boxplot(["Laplace" for _ in naive_trajectory_results], naive_trajectory_results, label="Standard", alpha=0.5, color=:lightblue, xlabel="", ylabel="CP")
...
naive_trajectory_results = deserialize("pointwise_solutions_total_laplace.jld")
