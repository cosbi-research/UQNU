#= 
Script to run the training of the cell apoptosis UDE model on the dataset with error level 0.0, fixing p2 and p4 to their literature values
=#
...
function train_uode_model(seed, iterator)
  ...
  function callback(θ, l, training_epochs, training_costs, best_training_parameters)
    ...
    #max 8 hours for an optimization
