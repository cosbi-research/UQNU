...
learning_rate_adam = 0.02101281356982488
group_size = 19
continuity_term = 0.0019363899490936972
...
p1 = 13.730742708147904
p2 = 89.64127927702877
p3 = -1.0415126416157812
p4 = 5.737258382381368
p5 = 3.09619219697368
p6 = 3.311356294999425
p7 = 1.3889609898667161
p8 = 4.539579392686686
p9 = 19.38264487138341
p10 = 866.3462310062107
p11 = 70.21999431208997
p12 = 2.08909212209709
p13 = 0.797352016817384
p14 = 17.388500112316365
...
function train_uode_model(seed, iterator)
  ...
  try
    optf2 = Optimization.OptimizationFunction((x, p) -> loss_multiple_shooting(x, Vern7(), InterpolatingAdjoint(autojacvec=ReverseDiffVJP(true))), adtype)
