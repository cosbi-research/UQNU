...
ensembles = []
for trajectory in 1:3
    for i in 1:10
        maximized_ensemble_folder = "../results_maximized_traj_$trajectory/lorenz/result_lorenz$i/results.jld"
...
Plots.plot!(plt, title="Lorenz (MOD ensembles), mean CP: $mean_cicp", legend=:topleft)
Plots.plot!(plt, 
