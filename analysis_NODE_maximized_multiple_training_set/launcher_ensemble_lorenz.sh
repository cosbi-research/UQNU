...
#SBATCH --output=ensemble_constraint_lorenz.out  # Standard output will be written to this file
#SBATCH --error=ensemble_constraint_lorenz.err   # Standard error will be written to this file
