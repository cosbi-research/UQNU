...
for trajectory in 1:3
    for i in 1:10
        maximized_ensemble_folder = "../results_maximized_traj_$trajectory/lv/result_lv$i/results.jld"
...
Plots.plot!(plt, title="Lotka-Volterra (MOD ensembles), mean CP: $mean_cicp", legend=:topleft)
Plots.plot!(plt, 
