...
Plots.plot!(plt, title="Lotka-Volterra (standard ensembles), mean CP: $mean_cicp", legend=:topleft)
Plots.plot!(plt, 
...
single_cicps_copied = single_cicps
single_cicps_copied = abs.(single_cicps_copied .- 0.95)
