...
for trajectory in 1:3
    for i in 1:10
        maximized_ensemble_folder = "../results_maximized_traj_$trajectory/damped/result_damped$i/results.jld"
...
Plots.plot!(plt, title="Damped Oscillator (MOD ensembles)", legend=:topleft)
Plots.plot!(plt, 
...
Plots.savefig(plt, "ground_truth_in_ensemble.png")
Plots.savefig(plt, "ground_truth_in_ensemble.svg")
...
serialize("cicps_distribution.jld", single_cicps)