...
plt = histogram(log10.(norm_last_point), bins=-3:0.1:2.1, label="NODE", xlabel="Last state norm (log10)", ylabel="Percentage", title="Region 1", legend=:topright, color=:blue, alpha=0.5, normalize=:probability)
histogram!(log10.(norm_last_point_original), bins=-3:0.1:(2.1), label="Ground truth", color=:grey, alpha=0.5, normalize=:probability)
Plots.plot!(plt,
    xguidefont=font(18),    # Increase x-axis label font size
    yguidefont=font(18),
    titlefont=font(16),
...
#histogram of the last points
plt = histogram(log10.(norm_last_point), bins=-3:0.1:2.1, label="NODE", xlabel="Last state norm (log10)", ylabel="Percentage", title="Region 2", legend=:topright, color=:blue, alpha=0.5, normalize=:probability)
histogram!(log10.(norm_last_point_original), bins=-3:0.1:2.1, label="Ground truth", color=:grey, alpha=0.5, normalize=:probability)
Plots.plot!(plt,
    xguidefont=font(18),    # Increase x-axis label font size
    yguidefont=font(18),
...
#histogram of the last points
plt = histogram(log10.(norm_last_point), bins=-3:0.1:2.1, label="NODE", xlabel="Last state norm (log10)", ylabel="Percentage", title="Region 3", legend=:topright, color=:blue, alpha=0.5, normalize=:probability)
histogram!(log10.(norm_last_point_original), bins=-3:0.1:2.1, label="Ground truth", color=:grey, alpha=0.5, normalize=:probability)
Plots.plot!(plt,
    xguidefont=font(18),    # Increase x-axis label font size
    yguidefont=font(18),
