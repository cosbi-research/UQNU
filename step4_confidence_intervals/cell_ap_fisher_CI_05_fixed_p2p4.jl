#= 
Script to derive the confidence intervals for the identifiable mechanistic parameters in the cell apoptosis UDE model trained on DS_05 fixing the parameters p2 and p4 to their literature values.
=#
...
open("results/cell_ap_fisher_CI_005_fixed_p2p4.txt", "w") do io
...
Serialization.serialize("results/cell_ap_opt_05_fisher_CI_fixed_p2p4.jld", confidence_intervals)
