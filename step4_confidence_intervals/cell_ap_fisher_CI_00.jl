#= 
Script to derive the confidence intervals for the identifiable mechanistic parameters in the cell apoptosis UDE model trained on DS_00
=#
...
open("results/cell_ap_fisher_CI_00.txt", "w") do io
...
Serialization.serialize("results/cell_ap_opt_00_fisher_CI.jld", confidence_intervals)
