#= 
Script to derive the confidence intervals for the identifiable mechanistic parameters in the cell apoptosis UDE model trained on DS_05 fixing the parameters p2 and p4 fixed to their literature values
...
function get_covariance_matrix(parameters_to_consider)
  ...
  normalization_factor = maximum(ode_data_sd[observables,2:end], dims=2)
...
open("results/cell_ap_fisher_CI_05_fixed_p2p4_observable_56.txt", "w") do io
...
Serialization.serialize("results/cell_ap_opt_05_fisher_CI_fixed_p2p4_observable_56.jld", confidence_intervals)