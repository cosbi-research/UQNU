#= 
Script to derive the confidence intervals for the identifiable mechanistic parameters in the Yeast glycolysis UDE model trained on DS_00
=#
...
par_opt = deserialize("local_optima_found/glyc_opt_00.jld")
...
open("results/glyc_fisher_CI_00.txt", "w") do io
...
Serialization.serialize("results/glyc_opt_00_fisher_CI.jld", confidence_intervals)