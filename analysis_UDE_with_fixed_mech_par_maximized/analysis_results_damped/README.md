...
This folder contains the scripts to analyze the results of partial reconstruction (with fixed mechanistic parameters) for the **Damped Oscillator** system.
...
- `evaluation_stopping_criterion.jl` julia script to evaluate the behaviour of the objective function (quantifying the disagreeement) 
---
