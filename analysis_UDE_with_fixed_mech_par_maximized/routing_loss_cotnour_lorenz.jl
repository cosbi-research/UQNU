...
function getVarianceGradient(par, points, total_ensemble, ood_analyzer)
  ...
  gradient_in_single_points_y1 = gradient_in_single_points_y1
  ...
  gradient_in_single_points_y2 = gradient_in_single_points_y2
...
if initial_cost > validation_cost_threshold
  ...
  for new_index in remaining_indexes
    ...
    @info "Validation cost: " initial_cost
