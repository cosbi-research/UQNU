...
"""
function get_uode_model_function(appr_neural_network, state, lower_bounds, upper_bounds)
...
function get_uode_model_function_not_scaled(appr_neural_network, state)
    #generates the function with the parameters
    f(du, u, p, t) =
