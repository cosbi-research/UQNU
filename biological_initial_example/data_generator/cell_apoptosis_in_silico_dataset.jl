...
plot_death = Plots.plot(sol_death, xlabel="Time (hours)", ylabel="Cell populations (normalized)",  title="Cell populations over time (Death Initial Condition)")
Plots.savefig(plot_death, "cell_populations_over_time_death_initial_condition.png")
