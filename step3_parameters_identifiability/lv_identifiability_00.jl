...
Plots.svg(plt, "plots/composition_projections_lv_e00.svg")
...
Plots.svg(plt_y1y2, "plots/qualitative_proof_compensating_lv_e00.svg")


gr()
i=1
plt = Plots.plot(legend=:outerbottom, foreground_color_legend = nothing, left_margin = 200px, xtickfontsize=10,ytickfontsize=10, xguidefontsize=12, yguidefontsize=12, legendfontsize=18, size=(1500, 450), dpi=300)
plot!(plt, legend=:outerbottom, foreground_color_legend = nothing)
plot!(plt, original_simulation_data.t, original_simulation_data[i, :], label="Original", color="lightgreen", linewidth=10)
plot!(plt, perturbed_simulation_data.t, perturbed_simulation_data[i, :], label="10% perturbation of α along the projection", color="blue", linewidth=3)
plot!(plt, original_simulation_data.t, perturbed_only_alpha_simulation_data[i, :], label="10% perturbation solely of α", color="red", linewidth=3)
...
savefig(plt, "plots/qualitative_proof_compensating_legend.svg")
