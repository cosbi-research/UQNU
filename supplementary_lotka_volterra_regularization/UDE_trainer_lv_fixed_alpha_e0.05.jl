#= 
Script to train the Lotka Volterra UDE model for fixed (and vartying) values of the mechanistic parameter on DS_0.05
=#
...
result_name_string = "lotka_volterra_0.05.jld"
...
result_name_string = "lv_" * result_name_string * "_" * error_level * "_"
...
# using the hyperparameters from the hyperparameter tuning for error 5%
