#= 
Script to analyse the results of the Lotka Volterra UDE model trained with fixed (and vartying) values of the mechanistic parameter on DS_0.00
=#
...
result_folder = "profiler_analysis_e0.00"
...
profile_results = deserialize("raw_results/lotka_volterra_0.0.jld")
