#= 
Script to assess the identifiability of the mechanistic parameters in the Yeast glycolyusis UDE model trained on DS_05 assuming only y5 and y6 observables
=#
...
Plots.plot!(plt, legend=false, foreground_color_legend = nothing, size = (1500, 500), left_margin = 10mm,  bottom_margin = 10mm, top_margin = 1mm, palette = :mk_12)
...
Plots.svg(plt, "plots/composition_projections_glyc_e05_observable_56_epsilon_5.svg")
...
Plots.svg(plt, "plots/composition_projections_glyc_e05_observable_56_epsilon_4.svg")
...
Plots.svg(plt, "plots/composition_projections_glyc_e05_observable_56_epsilon_6.svg")