#= 
Script to assess the identifiability of the mechanistic parameters in the Yeast glycolyusis UDE model trained on DS_05
=#
...
using DiffEqFlux, .Flux, Suppressor, QuasiMonteCarlo, Zygote, StatsPlots
...
Plots.svg(plt, "plots/composition_projections_glyc_e05_epsilon_4.svg")
...
Plots.svg(plt, "plots/composition_projections_glyc_e05_epsilon_6.svg")